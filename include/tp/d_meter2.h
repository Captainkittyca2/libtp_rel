...
namespace libtp::tp::d_meter2
{
    struct dMeter2_c
    {
        ...
        /* 0x250 */ uint8_t field_0x250[0x25e - 0x250];
        /* 0x25E */ int16_t field_0x246;
        /* 0x260 */ uint8_t field_0x260[0x268 - 0x260];
        #else
    ...
    extern "C"
    {
        ...
        int32_t _create(dMeter2_c* dMeterPtr);
        /**
        ...
        */
        ...
        /**
         * @brief Modifies the bomb value.
         * 
         * @param dMeterPtr A pointer to the current dMeter2 structure.
        */
        void moveBombNum(dMeter2_c* dMeterPtr);

        /**
         * @brief Modifies the arrow value.
         * 
         * @param dMeterPtr A pointer to the current dMeter2 structure.
        */
        void moveArrowNum(dMeter2_c* dMeterPtr);

        /**
         * @brief Modifies the slingshot value.
         * 
         * @param dMeterPtr A pointer to the current dMeter2 structure.
        */
        void movePachinkoNum(dMeter2_c* dMeterPtr);
       ...
       */
       ...
       void alphaAnimeOxygen(dMeter2_c* dMeterPtr);

       void alphaAnimeButton(dMeter2_c* dMeterPtr);

       void alphaAnimeButtonCross(dMeter2_c* dMeterPtr);

       int32_t isArrowEquip(dMeter2_c* dMeterPtr);

       int32_t isPachinkoEquip(dMeter2_c* dMeterPtr);

       void onArrowSoundBit(dMeter2_c* dMeterPtr, int32_t bit);

       void offArrowSoundBit(dMeter2_c* dMeterPtr, int32_t bit);

       bool isArrowSoundBit(dMeter2_c* dMeterPtr, int32_t bit);
    }
} // namespace libtp::tp::d_meter2
#endif
